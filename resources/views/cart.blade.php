                            ...
                            <div class="table-wrapper-responsive">
                                <table summary="Shopping cart">
                                    <tr>
                                        ...
                                        <th class="goods-page-description">Description</th> {{-- name --}}
                                        ...
                                        @if ($order)
                                            @foreach ($order->orderDetails as $orderDetail)
                                                <td class="goods-page-image">
                                                    <a href="javascript:;"><img src="{{ $orderDetail->product->img }}"
                                                            alt="Berry Lace Dress"></a>
                                                </td>
                                                <td class="goods-page-description">
                                                    <h3><a href="javascript:;">{{ $orderDetail->product->name }}</a></h3>
                                                ...
                                                {{-- <td class="goods-page-quantity">
                                                    <div class="product-quantity">
                                                        <input id="product-quantity" type="text" value="{{ $orderDetail->quantity }}" readonly
                                                ...
                                                <td class="quantity">
                                                    <input type="text" id="quantity" name="quantity"
                                                        class="form-control input-sm" value="{{ $orderDetail->quantity }}">
                                                </td>
                                                <td>
                                                    <form action="{{ route('cart.update') }}" method="post">
                                                        @csrf
                                                ...
                                                <td class="goods-page-price">
                                                    <strong><span>$</span>{{ currency_format($orderDetail->product->price) }}</strong>
                                                </td>
                                                <td class="goods-page-total">
                                                    <strong><span>$</span>{{ currency_format($orderDetail->total()) }}</strong>
                                                </td>
